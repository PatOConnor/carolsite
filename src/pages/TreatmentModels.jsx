...
const TreatmentModels = () => {
    return (
        <>
            ...
            <div className="flex flexible-layout two-column">
            ...
            <div className="flex flexible-layout two-column">
                <div className="body-section vertical-layout">
                    <SectionBlurb headerText="Internal Family Systems (IFS):" bodyText={<><p>Internal Family Systems (IFS) is a model of psychotherapy that maintains we are all made up of sub-personalities or “parts” that sometimes work to our advantage and protect us from unbearable emotions, thoughts and memories, but at other times over-function or overreact in ways that are not to our advantage. The goal of IFS is to help clients heal by developing a greater balance and harmony between these protective parts and burdened parts through a growing relationship with our own compassion, curiosity and sense of perspective about our inner experience.</p>
                        <p>The work in IFS then is to nurture our connection to our Self, and from this place, discover, learn, and engage with our parts, witness what they have been carrying, heal their traumas, release their roles, and discover what else they would like to be doing. IFS is grounded in the belief that healing comes from your parts being seen, recognized, and guided by your core Self, which rests on the strength of your Self’s relationship with each of your many parts.</p>
                        <p>IFS is based on the premise that all parts are valuable and have good intentions, and yet due to life’s circumstances, they often take on roles that come with heavy burdens, are extreme, and may be harmful to us in some way. IFS also assumes that everybody has an essential Self, which has the power to heal parts as well as provide guidance, wisdom, and harmony to our inner system. IFS is a highly collaborative, non-judgmental approach, where the experience of respect and appreciation for all our parts is prioritized, nurtured, and promoted in and outside of session. </p></>} />
                </div>

                <div className="body-section vertical-layout">

                    <SectionBlurb headerText="EMDR" bodyText=
                        {<>
                            <p>
