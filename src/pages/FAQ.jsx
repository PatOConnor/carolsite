...
const FAQ = () => {
    ...
    const faqJSX = [
        ...
        <SectionBlurb headerText={<>Policies</>} bodyText={<>I require 24 hours advance notice for appointment cancellation or rescheduling. The full fee will be charged for missed or cancelled sessions without such notification. Please note your insurance company cannot be billed for services that were not rendered.</>} />,
        <SectionBlurb headerText={""} bodyText={<>I accept checks, Zelle, or Venmo</>} />
    ]
